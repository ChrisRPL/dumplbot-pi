...
* `partial` scheduler + job UI. File-backed jobs API, schedule presets, natural-language phrases, capped run history, mock actions, and on-device status/save/detail/history/action flows landed; richer on-device editing still pending.
