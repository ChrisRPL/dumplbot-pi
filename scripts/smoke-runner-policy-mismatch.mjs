...
const runSmoke = async () => {
  const tmpRoot = await mkdtemp(join(tmpdir(), "dumplbot-runner-policy-smoke-"));
  ...
  await writeFile(
    ...
    [
      "id: strict-bash",
      "prompt_prelude: |",
      "  Strict mode fixture with bash in allowlist.",
      "tool_allowlist:",
      "  - read_file",
      "  - bash",
  ...
  try {
    ...
    console.log("runner policy mismatch smoke ok");
  } finally {
