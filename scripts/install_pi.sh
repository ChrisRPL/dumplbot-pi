...
maybe_reexec_with_sudo() {
  ...
  exec sudo \
    --preserve-env=DUMPLBOT_SERVICE_USER,DUMPLBOT_INSTALL_ROOT,DUMPLBOT_CONFIG_ROOT,DUMPLBOT_TMP_ROOT,DUMPLBOT_SYSTEMD_ROOT,DUMPLBOT_HEALTHCHECK_PATH,DUMPLBOT_SKIP_APT_BOOTSTRAP,DUMPLBOT_SKIP_NPM_BUILD,DUMPLBOT_SKIP_SYSTEMCTL \
    bash "$0" "$@"
}
